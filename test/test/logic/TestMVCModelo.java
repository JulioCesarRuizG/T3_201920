...
public class TestMVCModelo {
	...
	public void testShellsortOrganized() {
		  ...
		  assertEquals("El algoritmo no agregó correctamente los datos",true,proceso.darElemento(1).equals("30,80,5,900.0,100.0,30.0,50.0"));
		  assertEquals("El algoritmo no agregó correctamente los datos",true,proceso.darElemento(11).equals("11,20,5,400000.0,80000.0,45.0,23.0"));
	...
	public void testMergesortOrganized() {
		  ...
		  assertEquals("El algoritmo no agregó correctamente los datos",true,proceso.darElemento(1).equals("30,80,5,900,100,30,50"));
		  assertEquals("El algoritmo no agregó correctamente los datos",true,proceso.darElemento(21).equals("11,20,5,400000,80000,45,23"));
		  System.out.print("Para el ShellSort en el caso organizado,"+proceso.darElemento(0));
		}
		@Test
		public void testMergesortReversed() {
			  setUp2();
			  ArregloDinamico<String> proceso=modelo.OrdenarPorMergesort(datos);
			  assertEquals("El algoritmo no agregó correctamente los datos",0,proceso.darElemento(1).compareTo("30,80,5,900.0,100.0,30.0,50.0"));
			  assertEquals("El algoritmo no agregó correctamente los datos",0,proceso.darElemento(11).compareTo("11,20,5,400000.0,80000.0,45.0,23.0"));
			  System.out.print("Para el ShellSort en el caso organizado,"+proceso.darElemento(0));
			}
		@Test
